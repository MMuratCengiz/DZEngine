...
namespace DenOfIz
{
    ...
    DZ_API bool IsDepthFormat( const Format &format );
    DZ_API bool IsStencilFormat( const Format &format );
    DZ_API bool IsDepthOnlyFormat( const Format &format );
    DZ_API bool IsDepthStencilFormat( const Format &format );
    DZ_API bool HasStencilComponent( const Format &format );
    ...
    namespace ResourceDescriptor
    {
        ...
        constexpr uint32_t Buffer                = 1 << 1;
        constexpr uint32_t RWBuffer              = 1 << 2;
        constexpr uint32_t Texture               = 1 << 3;
        constexpr uint32_t RWTexture             = 1 << 4;
        constexpr uint32_t RenderTarget          = 1 << 5;
        constexpr uint32_t DepthStencil          = 1 << 6;
        constexpr uint32_t Sampler               = 1 << 7;
        constexpr uint32_t UniformBuffer         = 1 << 8;
        constexpr uint32_t RootConstant          = 1 << 9;
        constexpr uint32_t IndexBuffer           = 1 << 10;
        constexpr uint32_t VertexBuffer          = 1 << 11;
        constexpr uint32_t IndirectBuffer        = 1 << 12;
        constexpr uint32_t TextureCube           = 1 << 13;
        constexpr uint32_t AccelerationStructure = 1 << 14;
        constexpr uint32_t StructuredBuffer      = 1 << 15;
    } // namespace ResourceDescriptor

    namespace ResourceUsage
    {
        constexpr uint32_t Undefined                     = 1 << 1;
        constexpr uint32_t VertexAndConstantBuffer       = 1 << 2;
        constexpr uint32_t IndexBuffer                   = 1 << 3;
        constexpr uint32_t RenderTarget                  = 1 << 4;
        constexpr uint32_t UnorderedAccess               = 1 << 5;
        constexpr uint32_t DepthWrite                    = 1 << 6;
        constexpr uint32_t DepthRead                     = 1 << 7;
        constexpr uint32_t ShaderResource                = 1 << 8;
        constexpr uint32_t PixelShaderResource           = 1 << 9;
        constexpr uint32_t StreamOut                     = 1 << 10;
        constexpr uint32_t IndirectArgument              = 1 << 11;
        constexpr uint32_t CopyDst                       = 1 << 12;
        constexpr uint32_t CopySrc                       = 1 << 13;
        constexpr uint32_t GenericRead                   = 1 << 14;
        constexpr uint32_t Present                       = 1 << 15;
        constexpr uint32_t Common                        = 1 << 16;
        constexpr uint32_t AccelerationStructureRead     = 1 << 17;
        constexpr uint32_t AccelerationStructureWrite    = 1 << 18;
        constexpr uint32_t AccelerationStructureGeometry = 1 << 19;
        constexpr uint32_t ShaderBindingTable            = 1 << 20;
    } // namespace ResourceUsage
    ...
    struct DZ_API ShaderStructField
    {
        InteropString   Name;
    ...
    struct DZ_API ShaderStructFields
    {
        ShaderStructField *Elements;
