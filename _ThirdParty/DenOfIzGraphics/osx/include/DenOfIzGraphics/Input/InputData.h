...
namespace DenOfIz
{
    namespace KeyMod
    {
        constexpr uint32_t None     = 1 << 0;
        constexpr uint32_t LShift   = 1 << 1;
        constexpr uint32_t RShift   = 1 << 2;
        constexpr uint32_t LCtrl    = 1 << 3;
        constexpr uint32_t RCtrl    = 1 << 4;
        constexpr uint32_t LAlt     = 1 << 5;
        constexpr uint32_t RAlt     = 1 << 6;
        constexpr uint32_t LGui     = 1 << 7;
        constexpr uint32_t RGui     = 1 << 8;
        constexpr uint32_t NumLock  = 1 << 9;
        constexpr uint32_t CapsLock = 1 << 10;
        constexpr uint32_t AltGr    = 1 << 11;
        constexpr uint32_t Shift    = 1 << 12;
        constexpr uint32_t Ctrl     = 1 << 13;
        constexpr uint32_t Alt      = 1 << 14;
        constexpr uint32_t Gui      = 1 << 15;
    } // namespace KeyMod
