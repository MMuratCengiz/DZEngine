...
namespace DenOfIz
{
    ...
    public:
        ...
        DZ_API void ReadVertices( const AssetDataStream &stream, const MeshVertexArray &result ) const;
        DZ_API void ReadIndices16( const AssetDataStream &stream, const UInt16Array &result ) const;
        DZ_API void ReadIndices32( const AssetDataStream &stream, const UInt32Array &result ) const;
        DZ_API void ReadMorphTargetDeltas( const AssetDataStream &stream, const MorphTargetDeltaArray &result ) const;
        DZ_API void ReadConvexHullData( const AssetDataStream &stream, ByteArray &result ) const; // Todo maybe use proper types
