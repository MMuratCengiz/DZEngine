...
namespace DenOfIz
{
    ...
    public:
        ...
        DZ_API PipelineBarrierDesc &TextureBarrier( const TextureBarrierDesc &barrier )
        {
            m_textureBarriers.push_back( barrier );
            return *this;
        }

        DZ_API PipelineBarrierDesc &BufferBarrier( const BufferBarrierDesc &barrier )
        {
            m_bufferBarriers.push_back( barrier );
            return *this;
        }

        DZ_API PipelineBarrierDesc &MemoryBarrier( const MemoryBarrierDesc &barrier )
        {
            m_memoryBarriers.push_back( barrier );
            return *this;
        }

        DZ_API [[nodiscard]] TextureBarrierDescArray GetTextureBarriers( ) const
        {
            return TextureBarrierDescArray{ m_textureBarriers.data( ), m_textureBarriers.size( ) };
        }

        DZ_API [[nodiscard]] BufferBarrierDescArray GetBufferBarriers( ) const
        {
            return BufferBarrierDescArray{ m_bufferBarriers.data( ), m_bufferBarriers.size( ) };
        }

        DZ_API [[nodiscard]] MemoryBarrierDescArray GetMemoryBarriers( ) const
        {
            return MemoryBarrierDescArray{ m_memoryBarriers.data( ), m_memoryBarriers.size( ) };
        }

        DZ_API static PipelineBarrierDesc Uav( )
        {
        ...
        DZ_API static PipelineBarrierDesc UndefinedToRenderTarget( ITextureResource *resource )
        {
            PipelineBarrierDesc barrier;
        ...
        DZ_API static PipelineBarrierDesc RenderTargetToPresent( ITextureResource *resource )
        {
            PipelineBarrierDesc barrier;
            TextureBarrierDesc  textureBarrier{ };
        ...
        DZ_API static PipelineBarrierDesc RenderTargetToShaderResource( ITextureResource *resource )
        {
            PipelineBarrierDesc barrier;
            TextureBarrierDesc  textureBarrier{ };
            textureBarrier.OldState = ResourceUsage::RenderTarget;
