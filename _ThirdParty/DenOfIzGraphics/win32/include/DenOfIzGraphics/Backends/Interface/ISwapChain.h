...
namespace DenOfIz
{
    ...
    //! \brief HDR color space options
    enum class ColorSpace
    {
        sRGB,  // Standard RGB color space
        HDR10, // HDR10 color space
        ScRGB, // Extended linear color space
    };
    ...
    struct DZ_API SwapChainDesc
    {
        ...
        uint32_t              NumBuffers        = 3; // 2 for double buffering, 3 for triple buffering
        ...
        MSAASampleCount       SampleCount       = MSAASampleCount::_1;
    };
    ...
    public:
        ...
        virtual PresentResult Present( uint32_t imageIndex ) = 0;
