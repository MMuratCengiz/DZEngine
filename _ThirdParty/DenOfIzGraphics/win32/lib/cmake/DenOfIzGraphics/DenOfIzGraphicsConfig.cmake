...
if (WIN32)
    ...
    get_target_property(_target_type DenOfIz::DenOfIzGraphics TYPE)
    if(_target_type STREQUAL "SHARED_LIBRARY")
        set_property(TARGET DenOfIz::DenOfIzGraphics PROPERTY
            IMPORTED_IMPLIB_DEBUG "${PACKAGE_PREFIX_DIR}/lib/DenOfIzGraphics.lib"
        )
        set_property(TARGET DenOfIz::DenOfIzGraphics PROPERTY
            IMPORTED_IMPLIB_RELEASE "${PACKAGE_PREFIX_DIR}/lib/DenOfIzGraphics.lib"
        )
        set_property(TARGET DenOfIz::DenOfIzGraphics PROPERTY
            IMPORTED_IMPLIB_MINSIZEREL "${PACKAGE_PREFIX_DIR}/lib/DenOfIzGraphics.lib"
        )
        set_property(TARGET DenOfIz::DenOfIzGraphics PROPERTY
