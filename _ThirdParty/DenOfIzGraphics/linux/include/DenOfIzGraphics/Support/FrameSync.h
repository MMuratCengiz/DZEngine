...
namespace DenOfIz
{
    ...
    public:
        ...
        DZ_API void          ExecuteCommandList( uint32_t frame, const ISemaphoreArray &waitSemaphores, const ISemaphoreArray &signalSemaphores ) const;
        DZ_API uint32_t      AcquireNextImage( ) const;
