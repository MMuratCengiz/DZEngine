...
namespace DenOfIz
{
    ...
    public:
        ...
        DZ_API [[nodiscard]] ImporterResult     Import( const ShaderImportDesc &desc ) const;
        DZ_API [[nodiscard]] bool               ValidateFile( const InteropString &filePath ) const;


        DZ_API [[nodiscard]] static ShaderProgram *ImportCached( const ShaderProgramDesc &programDesc );
