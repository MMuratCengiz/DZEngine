...
namespace DenOfIz
{
    struct DZ_API LogicalDeviceDesc
    {
        /// When set to true, the API will automatically manage pipeline barriers
        bool AutoSync = true;
    };
    ...
    public:
        ...
        virtual void                CreateDevice( const LogicalDeviceDesc &desc = {} ) = 0;
