...
namespace DenOfIz
{
    ...
    struct DZ_API ByteArrayView
    {
        ...
        ByteArrayView( const void *Elements, const size_t NumElements )
        {
            this->Elements    = static_cast<const Byte *>( Elements );
            this->NumElements = NumElements;
        }
    };
    ...
    {
        uint32_t const *Elements    = nullptr;
        size_t          NumElements = 0;
    };

    struct DZ_API Int16Array
    {
        int16_t *Elements    = nullptr;
        size_t   NumElements = 0;
    };
    ...
    {
        StringView *Elements    = nullptr;
        size_t      NumElements = 0;
    };

    struct DZ_API InteropStringArray
    {
        InteropString const *Elements    = nullptr;
        size_t               NumElements = 0;
    };
} // namespace DenOfIz
